...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/git/external?repository-url=https://github.com/scosmaa/next-analytics.git&project-name=next-analytics&repository-name=next-analytics)
